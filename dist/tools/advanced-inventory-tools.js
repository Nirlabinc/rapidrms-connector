...
export const advancedInventoryTools = [
    ...
    },
    {
        ...
        description: 'Smart PO generation: analyzes custom date range sales, compares to previous purchases, suggests quantities.',
        input_schema: {
            type: 'object',
            properties: {
                analysisStartDate: {
    ...
    },
    {
        ...
        description: 'Compare sales between periods: biweekly, monthly, 3-month, year-over-year trends.',
        input_schema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Compare vendors for same item: price, quality (returns %), lead time, min order.',
        input_schema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Forecast PO needs for future periods: biweekly, monthly, 3 months based on trends.',
        input_schema: {
            type: 'object',
            properties: {
                forecastPeriod: {
