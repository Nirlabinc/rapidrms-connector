...
export const inventoryTools = [
    ...
    },
    {
        ...
        description: 'Get items below minimum stock threshold. Prioritized by days until stockout.',
        input_schema: {
            type: 'object',
            properties: {
                categoryId: {
    ...
    },
    {
        ...
        description: 'Forecast inventory needs based on sales velocity. Returns recommended order quantities.',
        input_schema: {
            type: 'object',
            properties: {
                lookbackDays: {
    ...
    },
    {
        ...
        description: 'Create a draft purchase order. Requires RAPIDRMS_WRITE_ENABLED=true to submit.',
        input_schema: {
            type: 'object',
            properties: {
                vendorId: {
