...
export const writeOperationsTools = [
    {
        ...
        description: 'Update item price for single/case/pack. Changes reflected immediately at POS.',
        input_schema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Set item margin target. System auto-calculates price if cost known, or cost if price known.',
        input_schema: {
            type: 'object',
            properties: {
                upc: { type: 'string', description: 'Item UPC or ID' },
    ...
    },
    {
        ...
        description: 'Update item metadata: name, description, category, sub-category, supplier.',
        input_schema: {
            type: 'object',
            properties: {
                upc: { type: 'string', description: 'Item UPC or ID' },
    ...
    },
    {
        ...
        description: 'Create new item with single/case/pack structure. Example: single@$2.99, case (12 singles)@$30, pack (50 singles)@$120.',
        input_schema: {
            type: 'object',
            properties: {
