...
export const analyticsInsightsTools = [
...

  {
    ...
    description:
      'Find slow-moving items with low sales velocity. Candidates for markdown or discontinuation.',
    input_schema: {
      type: 'object' as const,
      properties: {
...

  {
    ...
    description:
      'Forecast next week/month/quarter sales. Predict trends, prepare inventory, staff.',
    input_schema: {
      type: 'object' as const,
      properties: {
        forecastPeriod: {
