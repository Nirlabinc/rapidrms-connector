...
export const marketingIntegrationTools = [
  {
    ...
    description:
      'Create ad campaign on Facebook/Instagram for new items, promotions, or seasonal products.',
    input_schema: {
...

  {
    ...
    description:
      'Sync real-time inventory to Shopify, WooCommerce, or Amazon. Keep online stock accurate.',
    input_schema: {
      type: 'object' as const,
      properties: {
        ecommercePlatform: {
