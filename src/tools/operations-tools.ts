...
export const operationsTools = [
...

  {
    ...
    description:
      'Analyze inventory shrinkage: theft, damage, waste. Shows items and locations at risk.',
    input_schema: {
      type: 'object' as const,
      properties: {
        period: {
...

  {
    ...
    description:
      'Get recommendations for markdowns on slow-moving items to free up capital.',
    input_schema: {
      type: 'object' as const,
      properties: {
        minDiscount: {
...

  {
    ...
    description:
      'Analyze sales velocity by item: units/day, days to stockout, seasonal trends.',
    input_schema: {
      type: 'object' as const,
      properties: {
        sortBy: {
...

  {
    ...
    description:
      'Check for compliance issues: expired items, recalled products, storage violations.',
    input_schema: {
      type: 'object' as const,
      properties: {
        includeExpiring: {
