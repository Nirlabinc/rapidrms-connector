...
export const salesTools = [
  {
    ...
    description:
      'Get detailed sales report for a date range. Returns invoices, revenue, transaction count.',
    input_schema: {
...

  {
    ...
    description:
      'Compare revenue, transactions, or avg ticket between two periods. Calculates growth %.',
    input_schema: {
      type: 'object' as const,
      properties: {
        period1Start: {
